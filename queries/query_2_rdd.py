...
crime_incidents = spark.textFile("hdfs://okeanos-master:54310/data/crime_incidents_2010-2019.csv,hdfs://okeanos-master:54310/data/crime_incidents_2020-.csv")
...
query_2_rdd = crime_incidents.map(comma_splits) \
